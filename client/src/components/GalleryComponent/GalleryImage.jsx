          ...
          {Data.map((item) => (
            <div className="mx-auto w-[300px] rounded-md border border-black">
              {item.media_type === "VIDEO" ? (
                <>
                  <video  className="h-[200px] w-full rounded-t-md object-cover" controls>
              ...
              <div className="p-4">
                ...
                <p className="mt-3 text-sm text-gray-600">{item.media_type}</p>
                <div className="mt-4 flex justify-end">
                  <div className="w-auto p-1.5">
                    <a href={item.permalink}>
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-pink-300 border border-gray-300 hover:border-gray-400">
                        <svg
                          width="16"
                          height="15"
                          viewBox="0 0 16 15"
